...
class HappinessHistoryOptionScreen extends StatefulWidget {
  const HappinessHistoryOptionScreen({Key? key}) : super(key: key);

  @override
  State<HappinessHistoryOptionScreen> createState() => _HappinessHistoryOptionScreenState();
}

class _HappinessHistoryOptionScreenState extends State<HappinessHistoryOptionScreen> {
  @override
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, happinessCommulativeHistoryScreenRoute);
          },
          child: Container(
            margin: EdgeInsets.symmetric(
              horizontal: widget.constraints.maxWidth * 0.18,
