...
class HappinessIndexScreen extends StatefulWidget {
  const HappinessIndexScreen({Key? key}) : super(key: key);

  @override
  State<HappinessIndexScreen> createState() => _HappinessIndexScreenState();
}

class _HappinessIndexScreenState extends State<HappinessIndexScreen> {
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset(happinessIcon),
          ),
        ],
      ),
    );
...
class BodyWidget extends StatefulWidget {
  final BoxConstraints constraints;
  final HappinessIndex question;
  final List<HappinessIndexAnswer> answerList;
  final HappinessIndexAnswer answer;
  const BodyWidget({
    Key? key,
    required this.constraints,
