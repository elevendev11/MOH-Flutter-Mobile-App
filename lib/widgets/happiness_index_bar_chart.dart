...
class HappinessIndexBarChartWidget extends StatefulWidget {
  const HappinessIndexBarChartWidget({super.key, required this.barValues});

  final List<HappinessIndexResult> barValues;
